...
description: "Politique de confidentialité de Quel Placement : données collectées, finalités, durées de conservation, cookies et droits RGPD."
...
Le responsable du traitement des données collectées sur Quel Placement est l'éditeur du site, joignable à l'adresse contact@quel-placement.com. Toute question relative à la protection des données peut lui être adressée directement.

## Principe de collecte minimale

Quel Placement ne recueille que les données strictement nécessaires au fonctionnement du site et au traitement des demandes reçues. Aucune donnée n'est vendue, louée ni cédée à des tiers à des fins commerciales.
...
Ces droits s'exercent par simple demande adressée à contact@quel-placement.com. Une réponse vous est apportée dans un délai d'un mois. Si vous estimez que vos droits ne sont pas respectés, vous pouvez introduire une réclamation auprès de la Commission nationale de l'informatique et des libertés (CNIL), 3 place de Fontenoy, 75334 Paris Cedex 07, www.cnil.fr.
