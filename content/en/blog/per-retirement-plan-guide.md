---
title: "PER (French Retirement Savings Plan): the complete 2026 guide"
description: "Everything about the PER in 2026: how it works, entry and exit taxation, deduction cap, capital or annuity exit, best contracts."
date: 2026-04-19
lastmod: 2026-04-19
...
faq:
  - question: "What is the PER?"
    answer: "The PER (Plan d'Epargne Retraite) is a long-term savings product created by the Pacte Law in 2019. It allows you to build retirement capital with an immediate tax deduction on contributions."
  - question: "What is the PER deduction cap in 2026?"
    answer: "The deduction cap is 10 percent of the previous year's net professional income, limited to 8 times the PASS. A floor of 10 percent of the PASS applies for lower incomes."
  - question: "Can you withdraw money from the PER before retirement?"
    answer: "The capital is locked until retirement, except in cases of early release: purchase of the main residence, disability, spouse's death, end of unemployment rights, over-indebtedness, cessation of non-salaried activity."
  - question: "Capital or annuity exit on the PER?"
    answer: "Since the Pacte Law, 100 percent capital exit is possible for the individual PER. Annuity exit remains an option, often chosen to secure a lifetime income."
  - question: "Is the PER interesting for everyone?"
    answer: "The PER is mainly advantageous for households taxed at 30, 41 or 45 percent. For an untaxed household or in the 11 percent bracket, the tax interest is limited and other wrappers may be preferable."
---

<div class="callout-enbref">
<div class="callout-enbref-title">In short</div>
<ol>
<li>PER: French retirement savings product created in 2019, deductible from income tax</li>
<li>Deduction cap: 10 percent of previous year's professional income (limited to 8 PASS)</li>
<li>Exit possible in capital, annuity, or mix</li>
<li>Early release: main residence purchase, life accidents</li>
<li>Profitable from the 30 percent tax bracket</li>
</ol>
</div>
...
The three compartments can coexist within a single PER contract. This simplifies management when combining individual PER and corporate PER during your career.
</div>
...
The higher your marginal bracket, the more advantageous the PER. At 11 percent, the tax interest is low and a life insurance may be preferable to keep flexibility.
</div>
...
If your TMI is stable between working life and retirement, the PER simply defers tax without real savings. The real gain happens when your TMI drops at retirement (41 percent down to 30 percent for instance).
</div>
...
1. Main residence purchase (voluntary contributions only)
2. Death of spouse or PACS partner
3. Disability (2nd or 3rd category) of the saver, spouse or child
4. End of unemployment rights
5. Over-indebtedness (commission decision)
6. Cessation of non-salaried activity following judicial liquidation
...
<div class="callout-asavoir">
Online PER contracts offer the best rates. Conversely, branch-sold bank PERs often combine 3 percent entry fees with high management fees, heavily degrading the net return.
</div>
...
To deepen the tax comparison, see our dedicated article [PER vs life insurance](/en/blog/per-vs-life-insurance/). For global wealth optimisation, see our analysis of [IFI 2026](/en/blog/understanding-ifi-2026/).
