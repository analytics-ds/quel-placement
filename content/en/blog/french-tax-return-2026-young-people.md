---
title: "French tax return 2026 for young people: the complete guide"
description: "2026 tax return for students, apprentices and young workers in France: attachment to the parental household, allowances, dates and worked cases."
date: 2026-04-20
lastmod: 2026-04-20
...
imageAlt: "Young person filing their tax return online in 2026"
imageCredit: "Photo: Pexels"
draft: false
faq:
  - question: "Must a student declare their income in 2026?"
    answer: "Yes, but student salaries of people under 25 on January 1, 2025 benefit from an allowance of 5,405 euros (3 monthly SMIC). Beyond this, only the excess is taxable."
  - question: "Are apprentice salaries taxable?"
    answer: "Apprentices are exempt from income tax up to 21,622 euros gross in 2026 (i.e. one annual SMIC). Above that, only the excess is taxable."
  - question: "What are the 2026 tax return dates?"
    answer: "Opening on April 9, 2026. Online deadlines: May 21 for departments 1 to 19, May 28 for 20 to 54, June 4 for 55 to 974/976. Paper return: May 19, 2026."
  - question: "How to attach a young person to their parents' household?"
    answer: "Children under 21 (or under 25 if studying) can be attached to the parental tax household. The attachment entitles to an additional tax unit or a half unit, depending on the situation."
  - question: "Do interns pay tax on their gratifications?"
    answer: "No, within the limit of 21,622 euros per year (one annual SMIC). Above that, the excess is taxable under ordinary rules."
---

<div class="callout-enbref">
<div class="callout-enbref-title">In short</div>
<ol>
<li>2026 return opens April 9, closing from May 21 to June 4 depending on department</li>
<li>Student salaries: 5,405 euros allowance (3 monthly SMIC)</li>
<li>Apprentices: exempt up to 21,622 euros (1 annual SMIC)</li>
<li>Interns: 21,622 euros allowance on gratifications</li>
<li>Attachment to parental tax household possible up to age 25 for students</li>
</ol>
</div>
...
Even in case of low or zero income, declaring allows obtaining a tax notice, essential to access housing benefits (APL), scholarships, reduced transport fares or certain administrative procedures.
</div>
...
In case of attachment, the young person's income is added to the parents'. If the young person earns a good salary (CDI, long CDD, alternation), attachment may cause the loss of the family quotient benefit. Compare both scenarios before choosing.
</div>
...
<div class="callout-asavoir">
The 2026 campaign covers income received in 2025.
</div>
...
1. **Request a tax number**: retrieve it from the tax office or from the parental household notice
2. **Log in to impots.gouv.fr** with your personal credentials
3. **Verify pre-filled income**: salaries, benefits, gratifications
4. **Add income not automatically declared**: tips, income in kind, crypto, platforms (Vinted, LeBonCoin above a threshold)
5. **Report allowances**: specific line for student or apprentice salaries
6. **Validate and print the notice**: to keep for 3 years

<div class="callout-attention">
In the first year, the previous year's income is not pre-filled for withholding tax advance payments. You will need to fill in amounts manually to avoid a catch-up.
</div>
...
Youth taxation is very favourable: most have no income tax to pay thanks to student, apprentice and intern allowances. But declaring remains essential to obtain a tax notice, access benefits and avoid any omission that could be costly later.
</div>

If you run a side activity, micro-enterprise or freelance work, your return quickly gets more complex. Accounting firms such as In Extenso support young entrepreneurs from their very first filings.

## Useful links

[2026 income tax scale](/en/blog/french-income-tax-scale-2026/), [PER retirement plan guide](/en/blog/per-retirement-plan-guide/), [Livret A vs LDDS](/en/blog/livret-a-vs-ldds/), [Young protection insurance](/en/blog/young-protection-insurance/), [Glossary](/en/glossary/).
